...
(function (root) {
  ...
  const GAMES = [
    ...
    },
    {
      ...
      cta: 'EXTERMINATE ▶',
      boards: [
        { id: 'centipede', title: 'Infinite Centipede', group: 'Infinite', type: 'score', href: '/centipede/' },
        { id: 'centipede-classic', title: 'Classic Centipede', group: 'Classic', type: 'score', href: '/centipede/?mode=classic' },
      ],
      classicWin: ['centipede-classic'],
      achievements: [
        { id: 'centipede-15k', icon: '🐛', name: 'Bug Hunter', desc: 'Score 15,000 in Centipede', points: 20, kind: 'score', goal: 15000 },
        { id: 'centipede-75k', icon: '🕷️', name: 'Swarm Breaker', desc: 'Score 75,000 in Centipede', points: 50, kind: 'score', goal: 75000 },
        { id: 'centipede-classic', icon: '🍄', name: 'Garden Cleared', desc: 'Beat Classic Centipede', points: 40, kind: 'win', boards: ['centipede-classic'] },
      ],
    },
    {
    ...
    },
    {
      ...
      cta: 'PUSH ▶',
      boards: [
        { id: 'sokoban', title: 'Infinite Sokoban', group: 'Infinite', type: 'score', href: '/sokoban/' },
        { id: 'sokoban-classic', title: 'Classic Sokoban', group: 'Classic', type: 'time', href: '/sokoban/?mode=classic', minTime: 120 },
      ],
      classicWin: ['sokoban-classic'],
      achievements: [
        { id: 'sokoban-5', icon: '📦', name: 'Warehouse Worker', desc: 'Score 5,000 in Sokoban', points: 20, kind: 'score', goal: 5000 },
        { id: 'sokoban-25k', icon: '🏭', name: 'Logistics Legend', desc: 'Score 25,000 in Sokoban', points: 50, kind: 'score', goal: 25000 },
        { id: 'sokoban-classic', icon: '🥇', name: 'Thirty Rooms', desc: 'Beat Classic Sokoban', points: 40, kind: 'win', boards: ['sokoban-classic'] },
      ],
    },
    {
